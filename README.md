...
Day 29 - Problem 29
------
So today I started feeling that 1 day per problem will not be enough soon so I added Problem number to the headers in this diary. Today I played with sets a little bit. I also learned about the `functools.reduce()` method. I like this functional approach.